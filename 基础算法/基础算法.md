...
- [基础算法](#基础算法)
  ...
  - [搜索](#搜索)
    ...
    - [迭代加深搜索](#迭代加深搜索)
    - [搜索例题](#搜索例题)
      - [P1219 八皇后 Checker Challenge](#p1219-八皇后-checker-challenge)
        - [P1219题意](#p1219题意)
        - [P1219题解](#p1219题解)
  - [双指针、折半搜索](#双指针折半搜索)
  - [哈希、KMP](#哈希kmp)
...
##### [CF1355E Restorer Distance](https://www.luogu.com.cn/problem/CF1355E)
...
##### [CF436D Pudding Monsters](https://www.luogu.com.cn/problem/CF436D)
...
给定一个数 $n$，求 $n \times n$ 的棋盘中放置 $n$ 个棋子，使得每行、每列、每个对角线都只有一个棋子的放置方案数。
